...
public class PanelCustomization extends JFrame {
    ...
    // Рассчитываем отступ как 1/10 от размера панели
    ...
    // Устанавливаем шрифт пропорционально размеру панели
    ...
    private void createAndSavePanel() {
        ...
        layer = Integer.parseInt((String) layerCombo.getSelectedItem());
        if (useManualPosition) {
